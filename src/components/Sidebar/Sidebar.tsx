    ...
    <div className="sidebar">
      <div className="sidebar__content">
        <div className="sidebar__burger-menu" onClick={toggleMenu}>
          <img src={ICONS_BASE_URL + 'burger.svg'} alt="burger menu" className="sidebar__burger-icon" onClick={toggleMenu} />
        </div>

        <div>
          <div className="sidebar__logo">
            <img src={ICONS_BASE_URL + 'logo.svg'} alt="logo" className="sidebar__logo-icon" />
            <img src={ICONS_BASE_URL + 'version.svg'} alt="version" className="sidebar__version-icon" />
          </div>
              ...
              {navigationItems.map((item) => (
                ...
                >
                  <div className="sidebar__nav-item--title">
                    <img src={ICONS_BASE_URL + item.icon + '.svg'} alt={`${item.title} icon`} className="sidebar__icon" />
                    {item.title}
                  </div>
                  <img src={
                    item.selected
